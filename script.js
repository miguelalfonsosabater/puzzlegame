...
function startGame() {
    ...
    for (rowCount = 0; rowCount < rows; rowCount++) {
        for (columnCount = 0; columnCount < columns; columnCount++) {
            ...
            tile.addEventListener('dragstart', dragStart); //this is to start the drag sequence
            ...
            tile.addEventListener('dragLeave', dragLeave); // this is where you drag leaving the dragenter move
